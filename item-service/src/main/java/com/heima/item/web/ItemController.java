...
import com.heima.item.config.CaffeineConfig;
...
public class ItemController {
    ...
    public Item findById(@PathVariable("id") Long id) {
        return caffeineConfig.itemCache().get(id, key -> itemService.getById(key));
    }

    @GetMapping("/stock/{id}")
    public ItemStock findStockById(@PathVariable("id") Long id) {
        return caffeineConfig.stockCache().get(id, key -> stockService.getById(key));
    }
}
